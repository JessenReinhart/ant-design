(globalThis.utooChunk_antd||(globalThis.utooChunk_antd=[])).push(["object"==typeof document?document.currentScript:void 0,504595,e=>{"use strict";var t=e.i(833663);e.s(["Table",()=>t.default])},974327,e=>{"use strict";var t=e.i(391398);e.i(191788);var a=e.i(504595);let d=(0,e.i(827830).createStyles)(({css:e,token:t})=>{let{antCls:a}=t;return{customTable:e`
      ${a}-table {
        ${a}-table-container {
          ${a}-table-body,
          ${a}-table-content {
