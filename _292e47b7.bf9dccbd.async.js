(globalThis.utooChunk_antd||(globalThis.utooChunk_antd=[])).push(["object"==typeof document?document.currentScript:void 0,48750,e=>{"use strict";var t=e.i(251062);e.s(["LinkOutlined",()=>t.default])},417546,e=>{"use strict";var t=e.i(418031),n=e.i(353250);let o=t.default,i=n.default;e.s(["tokenData",0,i,"tokenMeta",0,o])},504595,e=>{"use strict";var t=e.i(833663);e.s(["Table",()=>t.default])},564062,e=>{"use strict";var t=e.i(191788);e.s(["default",0,(...e)=>{let[n,o]=(0,t.useState)(...e);return[n,(...e)=>{(0,t.startTransition)(()=>{o(...e)})}]}])},632086,750298,e=>{"use strict";var t=e.i(391398),n=e.i(191788),o=e.i(504595),i=e.i(827830),l=e.i(964473),r=e.i(987058),s=e.i(464745),a=e.i(210336);function d(){var e,t,n=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{},o=(0,l.default)((0,l.default)({},s.default),n.token),i=null!=(e=n.algorithm)?e:r.default,d=Array.isArray(i)?i.reduce(function(e,t){return t(o,e)},void 0):i(o),c=(0,l.default)((0,l.default)((0,l.default)({},d),n.components),{},{override:null!=(t=n.token)?t:{}});return(0,a.default)(c)}e.s(["getDesignToken",0,d],750298);var c=e.i(582225),u=e.i(183668),m=e.i(504909),p=e.i(788296),h=e.i(974398),g=e.i(973322),x=e.i(38415),k=e=>{let{controls:[o,i,l,r],width:s=180,height:a=s}=e,{token:d}=x.theme.useToken(),c=(e,t)=>"x"===t?e*s:a-e*a,u=s/5,m=(0,n.useId)();return(0,t.jsxs)("svg",{width:s,height:a,viewBox:`0 0 ${s} ${a}`,children:[(0,t.jsx)("title",{children:"Cubic Bezier Visualizer"}),(0,t.jsx)("rect",{width:"100%",height:"100%",fill:d.colorBgContainer}),(0,t.jsx)("pattern",{id:m,width:u,height:u,patternUnits:"userSpaceOnUse",children:(0,t.jsx)("path",{d:`
  ...
  `}));function S(){let[e]=(0,c.default)($),{styles:n}=C();return[{title:e.token,key:"name",dataIndex:"name"},{title:e.description,key:"desc",dataIndex:"desc"},{title:e.type,key:"type",dataIndex:"type",render:(e,o)=>(0,t.jsx)("span",{className:n.codeSpan,children:o.type})},{title:e.value,key:"value",render:(e,n)=>"string"==typeof n.value&&(n.value.startsWith("#")||n.value.startsWith("rgb"))?(0,t.jsx)(j.default,{value:n.value,enablePopover:!0,children:n.value}):"string"==typeof n.value&&n.value.toLowerCase().trim().startsWith("cubic-bezier")?(0,t.jsx)(b,{value:n.value}):"string"!=typeof n.value?JSON.stringify(n.value):n.value}]}e.s(["default",0,({type:e})=>{let[,i]=(0,c.default)($),l=S(),r=n.useMemo(()=>Object.entries(v.tokenMeta.global).filter(([,t])=>t.source===e).map(([e,t])=>({name:e,desc:"cn"===i?t.desc:t.descEn,type:t.type,value:T[e]})),[e,i]);return(0,t.jsx)(o.Table,{bordered:!0,rowKey:e=>e.name,dataSource:r,columns:l,pagination:!1})},"useColumns",0,S],632086)},686111,e=>{"use strict";var t=e.i(571246);e.s(["RightOutlined",()=>t.default])},720637,e=>{"use strict";var t=e.i(391398),n=e.i(191788),o=e.i(91595),i=e.i(771229),l=e.i(707065),r=e.i(183668),s=e.i(788296),a=e.i(624057),d=e.i(797091),c=e.i(927298),u=e.i(564062),m=e.i(926602),p=e.i(741214);let h=(0,e.i(827830).createStaticStyles)(({css:e,cssVar:t})=>({skeletonWrapper:e`
    width: 100% !important;
    height: 250px;
  ...
  `,tokenTitle:u.css`
    font-size: ${e.fontSizeLG};
    font-weight: bold;
  `})),j=e=>{let{defaultOpen:m=!0,tokens:j,title:v,helpText:T,helpLink:$,component:C,comment:S}=e,[,z]=(0,h.default)(y),w=(0,u.useTheme)(),M=(0,g.useColumns)(),[L,O]=(0,n.useState)(m),{styles:N}=b(),D=(0,n.useMemo)(()=>{let e=C?`<ConfigProvider
  theme={{
    components: {
      ${C}: {
        /* ${S?.componentComment} */
...
>
  ...
</ConfigProvider>`;return p.default.highlight(e,p.default.languages.jsx||p.default.languages.javascript,"jsx")},[C,S]);if(!j.length)return null;let B=j.sort(C?void 0:k).map(e=>{let t=C?x.tokenMeta.components[C].find(t=>t.token===e):x.tokenMeta.global[e];return t?{name:e,desc:"cn"===z?t.desc:t.descEn,type:t.type,value:C?x.tokenData[C]?.component[e]:f[e]}:null}).filter(e=>null!=e);return(0,t.jsxs)(t.Fragment,{children:[(0,t.jsxs)("div",{className:N.tableTitle,onClick:()=>O(e=>!e),children:[(0,t.jsx)(l.RightOutlined,{className:N.arrowIcon,rotate:90*!!L}),(0,t.jsxs)(s.Flex,{className:N.tokenTitle,gap:"small",justify:"flex-start",align:"center",children:[v,(0,t.jsx)(a.Popover,{title:null,destroyOnHidden:!0,styles:{root:{width:400}},content:(0,t.jsxs)(c.Typography,{children:[(0,t.jsx)("pre",{dir:"ltr",style:{fontSize:12},children:(0,t.jsx)("code",{dir:"ltr",dangerouslySetInnerHTML:{__html:D}})}),(0,t.jsxs)("a",{href:$,target:"_blank",rel:"noopener noreferrer",children:[(0,t.jsx)(o.LinkOutlined,{style:{marginInlineEnd:4}}),T]})]}),children:(0,t.jsxs)("span",{className:N.help,children:[(0,t.jsx)(i.QuestionCircleOutlined,{style:{marginInlineEnd:4}}),T]})})]})]}),L&&(0,t.jsx)(r.ConfigProvider,{theme:{token:{borderRadius:0}},children:(0,t.jsx)(d.Table,{size:"middle",columns:M,bordered:!0,dataSource:B,style:{marginBottom:w.margin},pagination:!1,rowKey:e=>e.name})})]})};var v=n.default.memo(({component:e})=>{let[o]=(0,h.default)(y),i=(0,n.useMemo)(()=>{let{componentComment:e,globalComment:t}=o;return{componentComment:e,globalComment:t}},[o]),l=(0,n.useMemo)(()=>{let t=new Set;return e.split(",").forEach(e=>{let{global:n=[]}=x.tokenData[e]||{};n.forEach(e=>{t.add(e)})}),Array.from(t)},[e]);return(0,t.jsxs)(t.Fragment,{children:[x.tokenMeta.components[e]?.length>0&&(0,t.jsx)(j,{defaultOpen:!0,title:o.componentToken,helpText:o.help,helpLink:o.customizeTokenLink,tokens:x.tokenMeta.components[e].map(e=>e.token),component:e,comment:i}),l.length>0&&(0,t.jsx)(j,{defaultOpen:!0,title:o.globalToken,helpText:o.help,helpLink:o.customizeComponentTokenLink,tokens:l,comment:i})]})});e.s(["default",0,v])},758035,e=>{"use strict";var t=e.i(391398),n=e.i(191788),o=e.i(218589),i=e.i(831036);let l=(0,e.i(827830).createStyles)(({css:e,cssVar:t,token:n})=>({codeSpan:e`
    padding: 0.2em 0.4em;
    font-size: 0.9em;
    background: ${n.siteMarkdownCodeBg};
